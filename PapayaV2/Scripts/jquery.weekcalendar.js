            ...
            */
            _renderCalendarButtons: function ($calendarContainer) {
                ...
                if (options.buttons) {
                    ...
                    calendarNavHtml += '<input class=\"textbox\" id=\"date\" type=\"text\" style=\"width:70px\" />';
                    calendarNavHtml += '</div>';
                    calendarNavHtml += '<h2 class=\"wc-title\"></h2>';
                    calendarNavHtml += '</div>';
            ...
            */
            ...
            rowspan = '', colspan = '', calendarHeaderHtml;
                ...
                for (var i = 1; i <= options.daysToShow; i++) {
                    ...
                    calendarHeaderHtml += '<td ' + colspan + '></td>';
                }
            ...
            */
            _updateDayColumnHeader: function ($weekDayColumns) {
                ...
                _title = this._getCalendarTitle();
                    ...
                    var currentDay = self._cloneDate(self.element.data('startDate'));
                    $('.wc-toolbar .wc-title', self.element).html(this.formatDate(currentDay, options.dateFormat));
                }
